...
class InventarioApp:
    ...
    # Nota: se mantienen solo 2 pestañas (Gestión y Búsqueda). Pestaña de Reportes eliminada.
    ...
    def on_producto_select(self, event):
        ...
        if not values:
            return
        # values expected: (id, nombre, descripcion, precio, cantidad)
        try:
            self.producto_id.delete(0, tk.END)
    ...
    def crear_inventario_productos(self):
        ...
        # Vincular selección para rellenar el formulario
    ...
    def limpiar_filtros(self):
        ...
        # Nota: Pestaña de reportes eliminada (solo quedan 2 pestañas)
