"""Gestión de inventario con interfaz Tkinter y MySQL.

Este módulo contiene la clase InventarioApp que proporciona una
interfaz gráfica para administrar productos almacenados en una
base de datos MySQL. Soporta CRUD y búsquedas con filtros.
...
class InventarioApp:
    ...
    Proporciona una interfaz de usuario para gestionar productos almacenados
    en una base de datos MySQL. Contiene métodos para crear la UI,
    operaciones CRUD y búsquedas con filtros.
    """
    ...
    def cargar_productos(self):
        """Cargar todos los productos desde la base de datos y actualizar la tabla.

        No devuelve nada. Carga las filas desde la tabla `productos` y las
        inserta en `self.tabla_productos`. Si hay error, lo imprime en consola.
        """
        try:
    ...
    def guardar_producto(self):
        """Validar y guardar un nuevo producto en la base de datos.

        Lee los datos del formulario, valida tipos y rangos, y realiza un
        INSERT en la tabla `productos`. En caso de éxito refresca la tabla
    ...
    def actualizar_producto(self):
        """Actualizar un producto existente identificado por su ID.

        Valida el ID y los campos del formulario, ejecuta un UPDATE y
        refresca la tabla.
        """
    ...
    def eliminar_producto(self):
        """Eliminar el producto cuyo ID está en el campo 'ID'.

        Pide confirmación antes de ejecutar el DELETE.
        """
        id_text = self.producto_id.get().strip()
        if not id_text.isdigit():
    ...
    def limpiar_producto(self):
        """Limpiar los campos del formulario de gestión de productos."""
    ...
    def on_producto_select(self, event):
        """Rellenar los campos del formulario con la fila seleccionada en la tabla.

        Se utiliza como manejador del evento <<TreeviewSelect>>.
        """
